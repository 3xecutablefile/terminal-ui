class UpdateChecker {
    constructor() {
        ...
        https.get({
            ...
            headers: {
                "User-Agent": "HackerUI UpdateChecker"
            }
        }, res => {
                    ...
                    try {
                        ...
                        if (release.tag_name.slice(1) === current) {
                            ...
                            new Modal({
                                ...
                                message: `HackerUI <strong>${release.tag_name}</strong> is now available.<br/>Head over to <a href="#" onclick="require('electron').shell.openExternal('${release.html_url}')">github.com</a> to download the latest version.`
                            });
